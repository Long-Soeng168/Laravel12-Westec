...
const Testimonials = () => (
    <div className="flex min-h-screen items-center justify-center px-6 py-12">
        <div>
            <SectionHeader label="Testimonials" title="What Our Partners Say" />
            <div className="mx-auto max-w-screen-xl columns-1 gap-8 md:columns-2 lg:columns-3">
                {testimonials.map((testimonial) => (
                    <div key={testimonial.id} className="bg-accent relative mb-8 break-inside-avoid rounded-xl p-6">
